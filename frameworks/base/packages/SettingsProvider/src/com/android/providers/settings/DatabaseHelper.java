...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            // MY EDIT - Bind String to show Battery Percentage in Status Bar
            loadIntegerSetting(stmt, "status_bar_show_battery_percent", R.integer.def_status_bar_show_battery_percent);
