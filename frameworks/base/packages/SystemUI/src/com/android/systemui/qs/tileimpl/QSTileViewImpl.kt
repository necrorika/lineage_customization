...
constructor(
    ...
    private fun createTileBackground(): Drawable {
        ...
        // -- MY EDIT - Force QS Tiles as circles--
        // Force the layer drawable shapes to render as pure ovals
        if (backgroundBaseDrawable is android.graphics.drawable.GradientDrawable) {
            (backgroundBaseDrawable as android.graphics.drawable.GradientDrawable).shape = 
                android.graphics.drawable.GradientDrawable.OVAL
        }
        if (backgroundOverlayDrawable is android.graphics.drawable.GradientDrawable) {
            (backgroundOverlayDrawable as android.graphics.drawable.GradientDrawable).shape = 
                android.graphics.drawable.GradientDrawable.OVAL
        }
        // ------------------------------
