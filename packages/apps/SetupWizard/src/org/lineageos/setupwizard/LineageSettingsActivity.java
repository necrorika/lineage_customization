...
public class LineageSettingsActivity extends BaseSetupWizardActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // MY EDIT - in theory disables checkbox
        mMetrics.setChecked(false);
        //metricsRow.setVisibility(View.GONE);
    ...
    // MY EDIT - in theory force disables metrics but still allows me the user to check it 
    private void updateMetricsOption() {
    final Bundle myPageBundle = mSetupWizardApp.getSettingsBundle();
    // Default to false if the key doesn't exist in the bundle yet
